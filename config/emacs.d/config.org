...
(defun diego/org-bindings ()
  ...
  (evil-leader/set-key-for-mode 'org-mode
    ...
    "mxq" 'diego/org-wrap-with-block-quote
...
(use-package hydra
  ...
  (defmacro diego|sp-wrap-with (fname char)
    "Make function for setting the emphasis in org mode"
    `(defun ,fname (&optional arg)
       (interactive "P")
       (sp-wrap-with-pair ,char)))

  (diego|sp-wrap-with diego/sp-wrap-with-paren   "(")
  (diego|sp-wrap-with diego/sp-wrap-with-bracket "[")
  (diego|sp-wrap-with diego/sp-wrap-with-curly   "{")
  (diego|sp-wrap-with diego/sp-wrap-with-quote2  "\"")
  (diego|sp-wrap-with diego/sp-wrap-with-quote   "'")
...
"
  ...
  (defhydra hydra-transpose ()
    ...
    ("j" diego/move-line-or-region "line or region")
    ("k" diego/backward-move-line-or-region "backward line or region")
