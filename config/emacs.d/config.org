...
(use-package ivy
  ...
  (eval-when-compile
    ...
    (declare-function ivy-previous-history-element "ivy")
    (declare-function ivy-next-history-element "ivy"))
  :config
  (ivy-mode 1)
...
(use-package counsel
  ...
  :preface
  (eval-when-compile
    (declare-function ivy--format-function-generic "ivy")
    (declare-function counsel--yank-pop-truncate "counsel"))
  :config
...
(use-package flyspell
  ...
  (eval-when-compile
    ...
    (declare-function flyspell-get-word "flyspell")
    (declare-function flyspell-do-correct "flyspell")
...
(use-package google-this
  ...
  :preface
  (eval-when-compile
    (declare-function google-this--maybe-wrap-in-quotes "google-this"))
  :config
