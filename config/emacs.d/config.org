...
*A note on the font:* Check out [[http://mbauman.net/geek/2009/03/15/minor-truetype-font-editing-on-a-mac/][this post]] for advice on fixing the Consolas
font for os x. Last updated 2011, last successfully tested 09/2016 (by
myself).
#+BEGIN_SRC emacs-lisp
