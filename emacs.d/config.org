...
(define-minor-mode relative-line-numbers-mode
  ...
  (when (and relative-line-numbers-mode
             (not (minibufferp)))
...
(define-globalized-minor-mode global-relative-line-numbers-mode relative-line-numbers-mode
...
_i_ aggressive-indent:   %-3s`aggressive-indent-mode   _l_ rlines:              %-3s`relative-line-numbers-mode   _F_ focus:                 %-3s`focus-mode
...
"
    ...
    ("c" fci-mode nil)
    ("l" relative-line-numbers-mode nil)
