...
(defun propertize-active (&rest arguments)
  (if window-active?
  ...
  '((:eval (with-evil-tag-color
             (with-modeline-status
               (cond ((and window-active?
                      ...
                      (diego/make-xpm evil-tag-color 48 8))
                     ((not window-active?)
                      (diego/make-xpm "#1D2021" 48 8)))
               ;; (diego/make-xpm (if ;; window-active?
               ;;                     (and window-active?
               ;;                          (not (or (and (featurep 'eyebrowse)
               ;;                                        (< 1 (length (eyebrowse--get 'window-configs))))
               ;;                                   (bound-and-true-p anzu--state)
          ...
          (when window-active?
            (propertize-active
             ...
             `(:foreground
               ...
               :box (:color ,evil-tag-color :line-width 10))))))))
    ;; File modified
    " %* "
    ...
    (:eval (with-modeline-status
             (propertize-active  "%4l:%2c  " 'face '(:foreground "#A89984"))))
    ;; Major mode
    (:eval
     (with-modeline-status
