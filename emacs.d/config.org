...
(defvar diego/mode-line
  '((:eval (with-evil-tag-color
    ...
    ((:eval (with-modeline-status
              (when (and window-active?
                         (bound-and-true-p anzu--state))
                (with-evil-tag-color
                  (propertize-active (anzu--update-mode-line) 'face `(:foreground "#3E3D31" :background ,evil-tag-color :box (:color ,evil-tag-color :line-width 10))))))))
    ;; (:eval (with-modeline-status
    ...
    ;;                            evil-mode-line-tag))
    ;;                   (background (pcase (substring-no-properties
    ;;                                       evil-mode-line-tag)
    ;;                                 (" N " "#B8BB26")
    ;;                                 (" I " "#66999D")
    ;;                                 (" M " "#D3869B")
    ...
    ;;                                   :foreground "#3E3D31"
    ;;                                   :weight bold
    ;;                                   ;; :box (:line-width 10 :color ,background)
    ;;                                   ))))))
    ;; File modified
    " %* "
