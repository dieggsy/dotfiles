...
(use-package google-this
  ...
  :general
  (diego/leader-keys "sd" 'ddg-this-search
...
(use-package ranger
  :commands diego/deer
  :general
  (diego/leader-keys "ad" 'diego/deer
  "ar" 'ranger)
  :init
  (require 'bookmark)
  :config
...
(use-package projectile
  :general
  (diego/leader-keys "pg" 'projectile-vc
...
(use-package counsel-projectile
  ...
  :general
  (diego/leader-keys "pb" 'counsel-projectile-switch-to-buffer
...
(use-package undo-tree
  :general (diego/leader-keys "au" 'undo-tree-visualize)
  :config
...
(defmacro with-evil-tag-color (&rest body)
  (declare (indent defun))
  `(let ((evil-tag-color (pcase (substring-no-properties
                                 evil-mode-line-tag)
                           (" N " "#B8BB26")
                           (" I " "#66999D")
                           (" M " "#D3869B")
...
Source: http://tinyurl.com/y8ovcvsp"
  (propertize
   " " 'display
...
Source: http://tinyurl.com/y76p5dv8"
      ...
      (with-window-status
        (with-evil-tag-color
          (when window-active?
            (propertize-active
             window-active?
             (cond  ((bound-and-true-p anzu--state)
...
(with-eval-after-load 'calc-ext
  (bind-key "x" (lambda () (interactive) (counsel-M-x "^calc-")) calc-mode-map))
