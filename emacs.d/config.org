...
(defun hackerman ()
  (interactive)
  (let ((hacker-file (concat temporary-file-directory "hackerman.png"))
        (inhibit-message t))
    (unless (file-exists-p hacker-file)
      (url-copy-file "http://i2.kym-cdn.com/entries/icons/original/000/021/807/4d7.png" hacker-file t))
    (with-output-to-temp-buffer "*hackerman*"
      (princ (concat "file://" hacker-file)))
    ;; (find-file hacker-file)
