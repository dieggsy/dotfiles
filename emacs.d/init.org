...
(d/after 'org
  (setq org-agenda-text-search-extra-files '(agenda-archives)
        org-agenda-files '("~/syncthing/org/todo.org" "~/syncthing/org/gcal.org")
        org-default-notes-file "~/syncthing/org/todo.org"
        d/notes-file "~syncthing/org/notes.org"
        org-directory "~/syncthing/org"
        org-archive-location "~/syncthing/org/archive.org::"
        org-mobile-inbox-for-pull "~/syncthing/org/mobile.org"
...
(use-package geiser
  ...
  :config
  (define-advice geiser (:around (fn impl) d/reuse-existing)
    (if-let (buffer (cl-find-if (lambda (b)
                                  (eq 'geiser-repl-mode
