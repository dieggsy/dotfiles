...
(define-key evil-window-map ">" 'd/splitter/evil-window-increase-width)
(define-key evil-window-map "<" 'd/splitter/evil-window-decrease-width)
(define-key evil-window-map "+" 'd/splitter/evil-window-increase-height)
(define-key evil-window-map "-" 'd/splitter/evil-window-decrease-height)
(define-key evil-window-map "w" 'd/splitter/evil-window-next)
(define-key evil-window-map "W" 'd/splitter/evil-window-prev)
(define-key evil-window-map "r" 'd/splitter/evil-window-rotate-downwards)
(define-key evil-window-map "R" 'd/splitter/evil-window-rotate-upwards)
#+end_src
* Appearance
** Defaults
*** Startup
