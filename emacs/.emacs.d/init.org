...
(use-package counsel
  ...
  (setq conusel-org-goto-display-style 'path
        ...
        counsel-rg-base-command '("rg" "-M" "120" "--no-heading" "--line-number" "--color" "never" "%s")
...
(d/hook! org-mode
  (when (and (file-remote-p default-directory)
             (string-match-p "dieggsy@firefly:/srv/http/dieggsy.com"
                             default-directory))
...
(use-package whitespace
  ...
  (setq whitespace-global-modes '(not erc-mode ses-mode vterm-mode magit-status-mode))
...
#+begin_src emacs-lisp
(defmacro dieggsy/scheme-indent (&rest pairs)
...
(d/after 'scheme
  ...
  (dieggsy/scheme-indent
   ...
   (with-exception-handler 1) (with-syntax 1))

  ;; Chicken (geiser)
  (dieggsy/scheme-indent
   (assume 1) (compiler-typecase 1) (cond-expand 0) (condition-case 1) (cut 1)
   (cute 1) (declare 0) (dotimes 1) (ecase 1) (fluid-let 1) (foreign-lambda 2)
   ...
   (module 2) (regex-case 1) (select 1) (set! 1) (use 0)
...
(defun dieggsy/scheme-simple-keywords (keywords)
...
(defun dieggsy/scheme-keywords (builtin)
  (dieggsy/scheme-simple-keywords builtin)
  (font-lock-add-keywords
   'scheme-mode
   `(("\\[\\(else\\)\\>" . 1)
...
;; Chicken (geiser)
(dieggsy/scheme-simple-keywords
