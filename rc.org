...
for_window [title="^emacs@Mothership$"], mark "EDITOR", move scratchpad
bindsym $mod+space [con_mark="^EDITOR$"] scratchpad show
...
client.focused #2e9ef4 #EBDBD2 #2D2D2D #2e9ef4
