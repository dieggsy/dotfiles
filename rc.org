...
** config.nix
:PROPERTIES:
:header-args+: :tangle (when (eq system-type 'gnu/linux) "~/.config/nixpkgs/config.nix")
:END:
#+begin_src nix
{ pkgs }: {
  ...
  packageOverrides = super: let self = super.pkgs; in with self; rec {
    ...
    emacsHEAD = super.callPackage ~/dotfiles/nix-local/emacsHEAD {
    ...
    rustRegistry = super.callPackage ~/dotfiles/nix-local/rust-packages.nix { };
