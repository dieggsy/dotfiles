...
#+end_src
***** [[https://github.com/zsh-users/zsh-syntax-highlighting/][zsh-syntax-highlightiing]]
#+begin_src sh
...
fpath=(~/bin/zfuncs /usr/local/share/zsh-completions $fpath)
