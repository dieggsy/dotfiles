...
[ -d /usr/share/zsh/plugins/zsh-autopair ] && source /usr/share/zsh/plugins/zsh-autopair/autopair.zsh
...
[ -d /usr/share/zsh/plugins/zsh-history-substring-search ] && source /usr/share/zsh/plugins/zsh-history-substring-search/zsh-history-substring-search.zsh
[ -d /usr/share/zsh/plugins/zsh-notify ] && source /usr/share/zsh/plugins/zsh-notify/notify.plugin.zsh

function maybe_show_host {
    if [ -n "$SSH_CLIENT" ] || [ -n "$SSH_TTY" ]; then
        echo "%F{13}%n@%M%f "
    fi
}

export PROMPT="$(maybe_show_host)%F{7}%1~%f %F{167}%(!.#.λ)%f "
