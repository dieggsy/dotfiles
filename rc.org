...
source ~/.ghq/github.com/olivierverdier/zsh-git-prompt/zshrc.sh
setopt prompt_subst
...
if which brew > /dev/null; then
    ...
    source ~/.ghq/github.com/zsh-users/zsh-history-substring-search/zsh-history-substring-search.zsh
fi
...
fpath=(
    ...
    ~/.ghq/zsh-users/zsh-completions/src
